...
<div class="notify"><span id="notifyType" class=""></span></div>
    ...
    <?php
       ...
       echo '<form action="forgotHandler.php" method="POST" enctype="multipart/form-data" action="">';

        echo '<input  type="hidden" name="userNumber" value="'.$user_ID.'"> ';
        echo    'Email: <input type="text" name="email" size=56 style="height:30;"> <br>';
        echo    'Username: <input type="text"  name="username" size=56 style="height:30;"> <br>';
...
<div class="notify"><span id="notifyType" class=""></span></div>
    ...
    <?php
       ...
       echo '<form action="forgotHandler.php" method="POST" enctype="multipart/form-data" action="">';
        ...
        echo '<input  type="hidden" name="userNumber" value="'.$user_ID.'"> ';
        echo    'Email: <input type="text" name="email" size=56 style="height:30;"> <br>';
        echo    '<input type="submit" value="Send Username" name="post">';
